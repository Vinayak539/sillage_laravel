...
<head>
  ...
  <title>Sillage - Fragrances & Cosmetics</title>
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/img/logo/logo_2_2.png')}}" />
...
<body>
    ...
    <div class="inner">
      ...
      <nav class="offcanvas-menu">
        <ul>
          ...
          <li>
            <a href="#"><span class="menu-text">Designer</span></a>
            <ul class="offcanvas-submenu">
              <li><a href="about-us.html">Men's Perfume</a></li>
              <li><a href="cart.html">Women's Perfume</a></li>
          ...
          <li>
            <a href="#"><span class="menu-text">Ultra Niche</span></a>
      ...
      <div class="offcanvas-social py-30">
        <ul>
          ...
          <!-- <li>
          <a href="#"><img src="assets/img/whatsapp1.svg" width="20" style="margin: auto;"></a>
        </li> -->
          <li>
  ...
  <header>
            ...
            <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
              <div class="social-network2">
                <ul class="d-flex">
                  ...
                  <li class="">
                    <a href="https://www.instagram.com/" target="_blank"><span class="icon-social-linkedin"></span></a>
                  </li>
                  <!--  <li class="mr-3">
                  <a href="https://www.instagram.com/" target="_blank"
                    ><img src="assets/img/whatsapp1.svg" width="19"></a>
                </li> -->
                  <li class="mr-0">
                    <a href="tel:+918999786866" target="_blank"><span class="icon-phone"></span>
                      (+91) 89997 86866
                    </a>
                  </li>
              ...
              <div class="media-body">
                <div class="phone">
                  <a href="tel:(+123)4567890" class="text-white"
                    ><i class="icon-phone mr-1"></i> <!-- (+123)4567890 </a
                  >
                </div>
              </div>
            </div> -->
            ...
            <nav class="navbar-top pb-2 pb-sm-0 position-relative">
              <ul class="d-flex justify-content-center justify-content-md-end align-items-center">
                ...
                <li style="background-color:white;border-radius: 2px;">
                  <a href="login.html" style="color:black;"><i class="icon-user"
    ...
    <!-- header-middle satrt -->
    <div id="" class="header-middle theme1 py-15 py-lg-0">
      <div class="container position-relative">
        <div class="row align-items-center">
          <div class="col-12  d-lg-none">
            <div class="d-flex justify-content-between align-items-center mmtoff">
              ...
              <div class="mobile-menu-toggle theme1 d-lg-none right-side">
          ...
          <div class="col-xl-8 col-lg-7 d-none d-lg-block">
            <ul class="main-menu d-flex justify-content-center">
              ...
              <li class="position-static">
                <a href="shop-grid-3-column.html">Designer <i class="ion-ios-arrow-down"></i></a>
                <ul class="sub-menu">
                  <li>
                    <a href="blog-grid-3-column.html">Men's Perfume</a>

                  </li>
                  <li>
                    <a href="blog-grid-3-column.html">Women's Perfume</a>
              ...
              <li>
                <a href="blog-grid-3-column.html">Ultra Niche </a>
                <!-- <ul class="sub-menu">
                <li>
                  <a href="blog-grid-3-column.html">Men's Perfume</a>
                  <ul class="sub-menu">
                ...
                <li>
                  <a href="blog-single-left-sidebar.html">Women's Perfume</a> -->
                <!-- <ul class="sub-menu">
                    <li>
                      <a href="blog-list-left-sidebar.html"
                        >Blog List Left Sidebar</a
            ...
            <div class="footer-widget">
              <div class=" cbb1 mb-25">
                <div class="section-title">
                  <h2 class="title">Terms & Services</h2>
                </div>
              </div>
              <!-- footer-menu start -->
            ...
            <div class="footer-widget">
              ...
              <div class="nletter-form mb-35">
                <form class="form-inline position-relative"
                  ...
                  <button class="btn btn-lg btn-dark text-capitalize" type="submit" style="border-radius: 25px;
    height:47px;">
                    Sign up
                  </button>
                </form>
              ...
              <div class="product-sync-init mb-20">
                <div class="single-product">
                  <div class="product-thumb">
                    <img src="{{asset('assets/img/slider/thumb/1.jpg')}}" alt="product-thumb" />
                  </div>
                </div>
                <!-- single-product end -->
                <div class="single-product">
                  <div class="product-thumb">
                    <img src="{{asset('assets/img/slider/thumb/2.jpg')}}" alt="product-thumb" />
                  </div>
                </div>
                <!-- single-product end -->
                <div class="single-product">
                  <div class="product-thumb">
                    <img src="{{asset('assets/img/slider/thumb/3.jpg')}}" alt="product-thumb" />
                  </div>
                </div>
                <!-- single-product end -->
                <div class="single-product">
                  <div class="product-thumb">
                    <img src="{{asset('assets/img/slider/thumb/4.jpg')}}" alt="product-thumb" />
                  </div>
                </div>
                <!-- single-product end -->
              </div>
                ...
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)">
                      <img src="{{asset('assets/img/slider/thumb/1.1.jpg')}}" alt="product-thumb" /></a>
                  </div>
                </div>
                <!-- single-product end -->
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)">
                      <img src="{{asset('assets/img/slider/thumb/2.1.jpg')}}" alt="product-thumb" /></a>
                  </div>
                </div>
                <!-- single-product end -->
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)"><img src="{{asset('assets/img/slider/thumb/3.1.jpg')}}" alt="product-thumb" /></a>
                  </div>
                </div>
                <!-- single-product end -->
                <div class="single-product">
                  <div class="product-thumb">
                    <a href="javascript:void(0)"><img src="{{asset('assets/img/slider/thumb/4.1.jpg')}}" alt="product-thumb" /></a>
                  </div>
                </div>
                <!-- single-product end -->
              </div>
...
<!-- Mirrored from htmldemo.hasthemes.com/looki/looki/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jan 2021 15:03:48 GMT -->
