...
<nav class="breadcrumb-section theme1 bg-lighten2 pt-110 pb-110 contact" style="background-image: url('{{asset('assets/img/images/contact.jpg')}}');">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="section-title text-center">
            <h2 class="title pb-4 text-light text-capitalize">Contact Us</h2>
          </div>
        </div>
        <!-- <div class="col-12">
          <ol
        ...
        <div class="col-lg-6 col-12 mb-30">
          ...
          <div class="contact-page-side-content">
            ...
            <div class="single-contact-block">
              ...
              <p>
                <a href="tel:8850984298">Mobile: +91-8850984298</a>
              </p>
            ...
            <div class="single-contact-block">
              ...
              <p>
                <a href="mailto:connect@sillageniche.com">connect@sillageniche.com</a>
              </p>
              <!-- <p>
