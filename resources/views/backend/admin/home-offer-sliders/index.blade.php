                ...
                <table class="table table-striped table-hover" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{!! asset('storage/images/home-offer-sliders').'/'.$slider->image_url !!}" target="_blank"
                                    title="Slider Image">
                                    <img src="{!! asset('storage/images/home-offer-sliders').'/'.$slider->image_url !!}" alt="Slider Image"
                                        width="50px">
                                </a>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('admin.home-offer-sliders.edit', $slider->id) }}" class="dropdown-item"
                                            title="Edit Detail">
