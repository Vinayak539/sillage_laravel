        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table border="1" class="table table-bordered table-responsive">
                    ...
                    <tr>
                        <th colspan="12" class="bg-silver text-right text-uppercase">
                            ...
                            <p>+ CGST : Rs {{ $invoice->tax/2 }}</p>
                            <p>+ SGST : Rs {{ $invoice->tax/2 }}</p>
                            <p>- Discount : Rs {{ $invoice->discount }}</p>
                            @if($invoice->used_royalty_points)
                            <p>- Ranayas Coins : Rs {{ $invoice->used_royalty_points }}</p>
                            @endif
                ...
                <div>
                    ...
                    <a href="{{ url('/') }}/reach_us">ranayas.com</a> Or send a mail at
                    <a href="mailto:support@ranayas.com">support@ranayas.com</a>
                </div>
            </div>
        </div>
    </div>
