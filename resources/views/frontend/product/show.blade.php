                    ...
                    <div class="product-summary">
                        ...
                        <form action="#" class="variation-form mb--20">
                            ...
                            <div class="product-size-variations">
                                <p class="swatch-label">Select Size <strong
                                        class="swatch-label size size_lable"></strong>
                                    @if($product->category ? $product->category->name != 'Fragrance' : '')
                                    <span class="size-chart" data-toggle="modal" data-target="#sizeChart"> Size
                                        Chart</span>
                                    @endif
                                </p>
                        ...
                        <div class="offerSection">
                            ...
                            <p> Choose {{ $offers[0]->offered_quantity }} Free Perfume On Purchase Of
                                {{ $offers[0]->purchase_quantity }} <a href="javascript:void(0)" class="d-inline pull-right selectedOfferBtn text-black">View Selected Offer</a></p>
