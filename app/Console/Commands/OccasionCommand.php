    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            Mail::send(['html' => 'backend.mails.occasion'], ['user' => $user], function ($message) use ($user) {
                ...
                $message->subject('Hni Perfumes Pvt. Ltd - Shop Now and Get 20% off');
            });

            SMS::send($user->mobile, 'Hni - Wish you Happy Birthday on your Occasion, Shop Now and Get 20% off, Visit our website to avail offer - http://hnilifestyle.com/');
